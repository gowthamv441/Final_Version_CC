...
<form  class="myform" action="loginfirst.php" method="post">
	...
	<a href="emplogin.php"><input class="button button4" name="empbtn" type="button" id="emp_btn" value="Employee"></a> <br><br>
...
if(isset($_POST['authloginbtn']))
{
	...
	$query="select * from authinfotbl WHERE username='$username' AND password='$password'";
	$query_run=mysqli_query($con,$query);
	if(mysqli_num_rows($query_run)>0)
	{
		$row=mysqli_fetch_assoc($query_run);
		$_SESSION['username']=$row['username'];
		header('location:authfirst.php');
	}
	else
	{
